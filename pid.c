...
/* 位置式PID系数 */
float Position_KP=0.015,Position_KI=0.08,Position_KD=6.328;																		//Position_KD=6.382; 
//内环
float Incremental_KP = 0.22,Incremental_KI =  0.01055 , Incremental_KD = 0.25; //算是比较完美的参数了	
