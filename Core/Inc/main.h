...
// Disable printf to avoid semihosting / blocking in ISR during debugging.
// If you need debug output, use a safe method (GPIO toggle, ITM/SWO or a UART retarget).
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
...
#if 0
/* printf disabled previously; removed to avoid breaking <stdio.h> prototypes.
  If you want to disable or retarget printf, implement a retarget (fputc/_write)
  or enable ITM/SWO logging instead. */
#endif
